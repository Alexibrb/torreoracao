...
const LOCAL_STORAGE_KEY = 'prayerScheduleData';
function PrayerSchedule() {
    ...
    const [endTime, setEndTime] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(9);
    ...
    const generateTimeSlots = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PrayerSchedule.useCallback[generateTimeSlots]": (start, end, existingSlots = [])=>{
            const newSlots = [];
            if (end <= start) return [];
            const existingSlotsMap = new Map(existingSlots.map({
            ...
            for(let i = start; i < end; i++){
                const startTime = `${String(i).padStart(2, '0')}h`;
                const endTime = `${String(i + 1).padStart(2, '0')}h`;
        ...
        "PrayerSchedule.useEffect": ()=>{
            try {
                ...
                if (storedData) {
                    ...
                    const savedDate = new Date(parsedData.scheduleDate);
                    // Check if the stored schedule date is in the past
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isBefore$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isBefore"])(savedDate, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfToday$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfToday"])())) {
                        localStorage.removeItem(LOCAL_STORAGE_KEY); // Clear expired schedule
                    } else {
                        setScheduleDate(savedDate);
                        setSlots(parsedData.slots);
                        setIsScheduleDefined(parsedData.isScheduleDefined);
                        setStartTime(parsedData.startTime);
                        setEndTime(parsedData.endTime);
                        setWhatsAppSent(parsedData.whatsAppSent || false);
                    }
                }
            } catch (error) {
                console.error("Failed to load or parse schedule from localStorage", error);
            }
        }
    }["PrayerSchedule.useEffect"], []);
    ...
    const allSlotsBooked = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PrayerSchedule.useMemo[allSlotsBooked]": ()=>slots.length > 0 && slots.every({
    ...
    const handleSendToWhatsApp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PrayerSchedule.useCallback[handleSendToWhatsApp]": ()=>{
            ...
            const phoneNumber = '5577991395904';
    ...
    const handleAdminConfigSubmit = ()=>{
        if (scheduleDate && startTime < endTime) {
            ...
            const newSlots = generateTimeSlots(startTime, endTime, oldSlots);
            setSlots(newSlots);
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                    ...
                                    children: [
                                        ...
                                        isAdminMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                            ...
                                            children: isScheduleDefined ? "Voltar para Escala" : "Sair"
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/prayer-schedule.tsx",
                                            lineNumber: 287,
                                            columnNumber: 18
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                    children: isAdminMode ? 'Configure a data e o intervalo de horários para a escala de oração.' : 'Acesse para configurar a escala de oração.'
                                }, void 0, false, {
                                    fileName: "[project]/src/components/prayer-schedule.tsx",
                                    lineNumber: 295,
                                    columnNumber: 13
                        ...
                        isAdminMode ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                            children: [
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$popover$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PopoverContent"], {
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$calendar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Calendar"], {
                                                                ...
                                                                onSelect: (date)=>{
                                                                    const oldDate = scheduleDate;
                                                                    setScheduleDate(date);
                                                                    // Reset slots if date changes, otherwise keep them
                                                                    if (date && oldDate && date.getTime() !== oldDate.getTime()) {
                                                                        setSlots(generateTimeSlots(startTime, endTime));
                                                                        setWhatsAppSent(false); // Reset WhatsApp sent status on date change
                                                                    }
                                                                },
                                                                initialFocus: true,
                                                                locale: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$locale$2f$pt$2d$BR$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ptBR"],
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardFooter"], {
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        className: "w-full",
                                        children: "Salvar e Disponibilizar Agenda"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/prayer-schedule.tsx",
                                        lineNumber: 393,
                                        columnNumber: 18
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                className: "w-full",
                                children: isScheduleDefined ? "Editar Escala" : "Acessar como Admin"
                            }, void 0, false, {
                                fileName: "[project]/src/components/prayer-schedule.tsx",
                                lineNumber: 400,
                                columnNumber: 16
...
_s(PrayerSchedule, "3ktlSQ3vi2pchHrCh9lDugE5gZc=", false, function() {
    return [
...
//# sourceMappingURL=src_components_a3214ab1._.js.map