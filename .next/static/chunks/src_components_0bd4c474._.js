...
;
;
const SCHEDULE_STORAGE_KEY = "prayerScheduleData";
const WHATSAPP_STORAGE_KEY = "whatsAppConfig";
...
function PrayerSchedule() {
    ...
    const loadStateFromLocalStorage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PrayerSchedule.useCallback[loadStateFromLocalStorage]": ()=>{
            setIsLoading(true);
            try {
                const savedScheduleJSON = localStorage.getItem(SCHEDULE_STORAGE_KEY);
                if (savedScheduleJSON) {
                    const scheduleData = JSON.parse(savedScheduleJSON);
                    const savedDate = new Date(scheduleData.scheduleDate);
                    // Check if the saved date is in the past (ignoring time).
                    // If it is, clear the schedule. Otherwise, load it.
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isBefore$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isBefore"])(savedDate, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfToday$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfToday"])())) {
                        ...
                        // Reset to default state for a new schedule
                        ...
                        // Load the existing, valid schedule
                    ...
                    // No schedule found, ensure clean state
                    setIsScheduleDefined(false);
                    setScheduleDate(new Date());
                    setSlots([]);
                }
                const savedWhatsAppNumber = localStorage.getItem(WHATSAPP_STORAGE_KEY);
                if (savedWhatsAppNumber) {
                    setWhatsAppNumber(JSON.parse(savedWhatsAppNumber));
                }
            } catch (error) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PrayerSchedule.useEffect": ()=>{
            ...
            const handleStorageChange = {
                "PrayerSchedule.useEffect.handleStorageChange": (event)=>{
                    if (event.key === SCHEDULE_STORAGE_KEY || event.key === WHATSAPP_STORAGE_KEY) {
                        // When storage changes in another tab, reload the state here
                        loadStateFromLocalStorage();
                    }
                }
            }["PrayerSchedule.useEffect.handleStorageChange"];
    ...
    const updateAndSaveSchedule = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PrayerSchedule.useCallback[updateAndSaveSchedule]": (updatedData)=>{
            const currentState = {
            ...
            try {
                localStorage.setItem(SCHEDULE_STORAGE_KEY, JSON.stringify(newState));
            } catch (error) {
    ...
    }["PrayerSchedule.useCallback[updateAndSaveSchedule]"], [
        scheduleDate,
        slots,
        isScheduleDefined,
        startTime,
    ...
    const updateWhatsAppConfigInLocalStorage = (newNumber)=>{
        try {
            localStorage.setItem(WHATSAPP_STORAGE_KEY, JSON.stringify(newNumber));
    ...
    const handleAdminAuthSubmit = (values)=>{
        // NOTE: This is a simple, insecure password check.
    ...
    const handleAdminConfigSubmit = ()=>{
        ...
        updateAndSaveSchedule(newScheduleData);
        toast({
    ...
    const handleDeleteSchedule = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PrayerSchedule.useCallback[handleDeleteSchedule]": ()=>{
            try {
                ...
                // Forçar um recarregamento do estado para refletir a exclusão
                loadStateFromLocalStorage();
                toast({
                ...
                console.error("Failed to delete schedule from localStorage", error);
                toast({
                    title: "Erro ao Excluir",
                    description: "Não foi possível remover a escala do armazenamento local.",
                    variant: "destructive"
                });
            }
        }
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        size: "icon",
                                        onClick: ()=>updateWhatsAppConfigInLocalStorage(whatsAppNumber),
...
_s(PrayerSchedule, "UkXqTG1HD6KMJ6DNNwmshsBpq3s=", false, function() {
    return [
...
//# sourceMappingURL=src_components_0bd4c474._.js.map