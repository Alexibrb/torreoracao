...
function PrayerSchedule() {
    ...
    const generateTimeSlots = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((start, end, existingSlots = [])=>{
        const newSlots = [];
        if (end <= start) return [];
        const existingSlotsMap = new Map(existingSlots.map((s)=>[
                s.time,
                s
            ]));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setIsLoading(true);
        const scheduleRef = doc(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], 'schedules', SCHEDULE_DOC_ID);
        const unsubscribe = onSnapshot(scheduleRef, (docSnap)=>{
            if (docSnap.exists()) {
                ...
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isBefore$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isBefore"])(savedDate, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfToday$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startOfToday"])())) {
                    // If it's old, delete it. The next snapshot event will handle the "else" case.
                    deleteDoc(scheduleRef); // This will trigger onSnapshot again with docSnap.exists() as false
                } else {
                ...
                // No schedule exists or it was deleted (expired)
                // Reset to the initial state for creating a new schedule
    ...
    const updateScheduleInFirestore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (updatedData)=>{
        try {
            ...
            // or update it if it does. This is simpler and more robust.
            await setDoc(scheduleRef, updatedData, {
                merge: true
            });
        } catch (error) {
    ...
    const handleSendToWhatsApp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        ...
        const phoneNumber = '5577991395904'; // TODO: Make this configurable
    ...
    const handleBookingSubmit = async (values)=>{
        if (selectedSlot) {
            ...
            // The error toast is already handled in updateScheduleInFirestore
            }
        }
    };
    ...
    const handleAdminConfigSubmit = async ()=>{
        if (scheduleDate && startTime < endTime) {
            ...
            try {
                ...
                // Optimistically update local state to force UI transition
                setSlots(newSlots);
            ...
            // Error toast is already handled in updateScheduleInFirestore
            }
        } else {
            toast({
    ...
    const handleDeleteSchedule = async ()=>{
        try {
            ...
            // State will update via onSnapshot, which will set isScheduleDefined to false
            setIsDeleteDialogOpen(false);
            setIsAdminMode(false); // Go back to the "Create" screen
            toast({
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardHeader"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardDescription"], {
                                    children: isAdminMode ? 'Configure a data e o intervalo de horários para a escala de oração.' : 'Acesse para configurar ou editar a escala de oração.'
                                }, void 0, false, {
                                    fileName: "[project]/src/components/prayer-schedule.tsx",
                                    lineNumber: 359,
                                    columnNumber: 13
...
//# sourceMappingURL=src_13b96245._.js.map